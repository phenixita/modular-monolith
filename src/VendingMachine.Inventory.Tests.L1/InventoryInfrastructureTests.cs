...
[Trait("Level", "L1")]
public sealed class InventoryInfrastructureTests : IClassFixture<InfrastructureFixture>, IAsyncLifetime
{
    private readonly InfrastructureFixture _fixture;

    public InventoryInfrastructureTests(InfrastructureFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        // Arrange
        var repository1 = new PostgresInventoryRepository(_fixture.ConnectionString);
        ...
        var repository2 = new PostgresInventoryRepository(_fixture.ConnectionString);
        ...
        var repository3 = new PostgresInventoryRepository(_fixture.ConnectionString);
    ...
    {
        // Arrange
        var repository = new PostgresInventoryRepository(_fixture.ConnectionString);
